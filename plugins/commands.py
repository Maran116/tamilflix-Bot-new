...
async def start(client, message):
    ...
    if not await db.has_premium_access(message.from_user.id):
        if IS_VERIFY and not verify_status['is_verified']:
            ...
            await message.reply("🎉நீங்கள் 𝗩𝗘𝗥𝗜𝗙𝗬 செய்வதன் மூலம் நீங்கள் விரும்பும் படங்களை ஒரு நாள் முழுவதும்  விளம்பரம் இல்லாமல் பெற்றுக் கொள்ளலாம். 
                  
                                🔐 𝗬𝗢𝗨  𝗡𝗢𝗧  𝗩𝗘𝗥𝗜𝗙𝗜𝗘𝗗 ❌ 𝗧𝗢𝗗𝗔𝗬 𝗞𝗜𝗡𝗗𝗟𝗬 𝗩𝗘𝗥𝗜𝗙𝗬 𝗡𝗢𝗪 🔐", reply_markup=InlineKeyboardMarkup(btn), protect_content=True)return
    else:
        pass
