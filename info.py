...
# Bot information
API_ID = environ.get('API_ID', '22487047')  #api id of your telegram id
if len(API_ID) == 0:
    print('Error - API_ID is missing, exiting now')
    exit()
else:
    API_ID = int(API_ID)
API_HASH = environ.get('API_HASH', '7fea27db5c011ef2ed75074c4a195610') #api hash of your telegram id
if len(API_HASH) == 0:
    print('Error - API_HASH is missing, exiting now')
    exit()
BOT_TOKEN = environ.get('BOT_TOKEN', '7021558857:AAF_xacySWicTWpj9YWjGswbTCYAM_mjJ5M') #bot token from botfather
if len(BOT_TOKEN) == 0:
...
# Bot Admins
ADMINS = environ.get('ADMINS', '7490828321') #apni tg id daalo
if len(ADMINS) == 0:
...
# support group
SUPPORT_GROUP = environ.get('SUPPORT_GROUP', '-1002261140197') #support group id ex:  -1002936246860
...
# MongoDB information
DATABASE_URL = environ.get('DATABASE_URL',"mongodb+srv://tamilflix2:WIN3p2kSH8kPXtwb@cluster0.x2iqh.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0") #mongo db url
...
BIN_CHANNEL = environ.get("BIN_CHANNEL", "-1002406330623") #if is_stream = true then add a channel id ex: -10026393639
if len(BIN_CHANNEL) == 0:
    print('Error - BIN_CHANNEL is missing, exiting now')
    exit()
else:
    BIN_CHANNEL = int(BIN_CHANNEL)
URL = environ.get("URL", "https://github.com/Maran116/tamilflix-Bot-new") #if heroku then paste the app link here ex: https://heroku......./
if len(URL) == 0:
